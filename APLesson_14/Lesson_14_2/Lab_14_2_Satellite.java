...
public class Lab_14_2_Satellite
{
    public static void main(String[]args) 
	{
        ArrayList<Lab_14_2_Location> locate = new ArrayList<>();

		double[] honLoc = {5, 6};
		double[] home = {0, 0};
		
        locate.add(new Lab_14_2_Honda(honLoc));
        locate.add(new Lab_14_2_Toyota("8, 9"));
        locate.add(new Lab_14_2_GMC(3, 8));
